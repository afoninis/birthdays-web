Live demo: [GitHub Pages link](https://lunaquietmagic.github.io/birthdays-web/)<br />
...
Live demo: [GitHub Pages link](https://lunaquietmagic.github.io/birthdays-web/)
...
```bash
git clone https://github.com/lunaquietmagic/birthdays-web.git
```
